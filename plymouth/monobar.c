// This is the tribar plymouth plugin from plymouth 24.004.60 renamed to
// monobar with the following changes:
//
//  * We want a single white progress bar (not three) and hence the rename to
//    monobar
//  * The blue bar shows the actual progress, the white bar is always behind
//    and the brown bar is always ahead. We thus let the white bar remain
//    white (the color of the bar), make the blue color also white (this is
//    our progress bar) and make the brown color black (the background)
//  * Remove the "Fun made-up smoothing function" for more accurate progress
//    reporting instead of making it up.
//
// Copyright: 2025 Johannes Schauer Marin Rodrigues <josch@mister-muffin.de>
//
// --- tribar.c	2025-11-07 08:05:42.655259831 +0100
// +++ monobar.c	2025-11-07 08:10:23.193641099 +0100
// @@ -179,10 +179,10 @@
//                                            0xffffff);
